...
<body>
 ...
 <div id="navbar" class="navbar-collapse collapse">
    ...
    <label class="navbar-text text-center text-primary" style="vertical-align:10px;font-size:medium "><a href="index.php">HelpEachOther </a></label>
...
?>		<form method="post">
	...
	</div><label></label>	<textarea name="skill" rows='5' cols="100" placeholder="Enter Your Skills...e.g.PHP,Java" ><?php echo $res['skill']; ?></textarea>
<BR/><BR>
...
<label>Knows About :</label><br>
<textarea name="project" rows='4' cols="100"  placeholder="Describe what you know about?"><?php echo $res['project']; ?></textarea>
<BR/><BR>
